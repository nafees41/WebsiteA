          ...
          <Grid item md={6} sm={12} xs={12} key={index}>
            ...
            >
              <CardActionArea>
                ...
                <CardContent>
                  <Typography gutterBottom variant="body2" component="div" sx={{ textAlign: 'center', color: '#7F7F7F' }}>
                    23rd Oct, 2023
                  </Typography>
                </CardContent>
              </CardActionArea>
...
>
          ...
          <KeyboardBackspaceIcon sx={{color:'#7F7F7F' ,fontSize:'40px'}}/>
      ...
      <Divider variant="inset"  sx={{marginX:{md:'50px',sm:'0px',xs:'0px'} ,marginTop:'20px'}} />
